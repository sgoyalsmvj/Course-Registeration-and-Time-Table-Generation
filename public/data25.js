...
let courses = {
    ...
    // CSE
	'B501': new Course('Artificial Intelligence (LH3)', 'AI', 'B'),
	'B502': new Course('Economics For Engineers/Psychology, Technology and Society', 'EFE/PTS', 'D'),
	'B503': new Course('Introduction To Data Science (LH4)', 'IDS', 'A'),

	'B504': new Course('Software Engineering (C6)', 'SE', 'E'),
	'B505': new Course('Digital Communication', 'DC', 'F'),	
	'B506': new Course('Digital Signal Processing', 'DSP', 'C'),	
	'B704': new Course('Elective-4', 'E-4', 'G'),	
	'B701': new Course('Elective-5', 'E-5', 'I'),	
	'B702': new Course('Elective-3', 'E-3', 'H'),	
    'B703': new Course('Elective-6', 'E-6', 'K'),	
