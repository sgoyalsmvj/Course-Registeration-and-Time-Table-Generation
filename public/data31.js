...
let courses = {
  ...
  // CSE
	'P101': new Course('Classical Physics', 'CLP', 'C'),
	'P102': new Course('Mathematics - I ', 'CS', 'A'),
	'P103': new Course('Basic Electronics', 'BE', 'E'),
	'P104': new Course('Computer Programming', 'CP', 'B'),
	'P105': new Course('Technical Communication in English)', 'TCE', 'F'),	
	'P301': new Course('Mathematics  III ', 'MIII', 'P'),	
	'P302': new Course('Semiconductor Devices and Circuits ', 'SEMI', 'I'),	
	'P303': new Course('Signals and Systems ', 'SNS', 'Q'),	
	'P304': new Course('Engineering Electromagnetics', 'EEM', 'K'),
    'P305': new Course('Digital Circuits and Systems', 'DCS', 'O'),
